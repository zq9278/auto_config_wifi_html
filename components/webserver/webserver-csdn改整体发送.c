...
extern const char root_start[] asm("_binary_index_html_start");  // HTML起始指针

extern const char root_end[] asm("_binary_index_html_end"); // HTML结束指针
...
{
//     const size_t upload_script_size = (root_end - root_start);  // 计算HTML文件的大小
...
//                                  "Content-Length: %d \r\n\r\n";
//    httpd_resp_send_chunk(req, (const char *)HTTP_200, sizeof(HTTP_200));  // 发送额外的HTML内容
// //     httpd_resp_set_type(req, "text/html");
//     httpd_resp_send_chunk(req, (const char *)root_start, upload_script_size);  // 发送HTML文件的内容
